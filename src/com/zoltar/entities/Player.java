...
public class Player extends Race implements RenderStructure{
	...
	public void render(Graphics g) {
		// TODO Auto-generated method stub
		g.drawImage(this.getSkinByIndex(this.getIndex()), this.getX() - Camera.getCameraXOffSet(), this.getY() - Camera.getCameraYOffSet(), null);
	}
}
